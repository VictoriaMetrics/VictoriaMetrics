...
func (api *vmstorageAPI) GetMetricNamesUsageStats(qt *querytracer.Tracer, at *storage.TenantToken, limit, le int, matchPattern string, _ uint64) (storage.MetricNamesStatsResponse, error) {
	return api.s.GetMetricNamesStats(qt, at, limit, le, matchPattern), nil
}
