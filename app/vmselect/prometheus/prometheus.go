...
var (
	...
	maxTopNSeries       = flag.Int("search.maxTopNSeries", 1000, "The maximum number of time series that can be returned from /api/status/tsdb. This option allows limiting memory usage")
