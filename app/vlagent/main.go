...
func main() {
	...
	remotewrite.Init()
	vlinsert.Init()
	insertutil.SetMustAddRows(remotewrite.TryAddRows)
...
func usage() {
	const s = `
vlagetn collects logs via popular data ingestion protocols and routes it to VictoriaLogs.

See the docs at https://docs.victoriametrics.com/victoriametrics/vlagent/ .
`
	flagutil.Usage(s)
}
