...
export const AlertingRuleIcon = () => (
  <svg
    viewBox="446.983 310.979 28.674 31.057"
    fill="currentColor"
  >
    <path d="M452.983 324.979h10v2h-10zm0-6h12v2h-12z"/>
    <path d="M470.983 312.979a2 2 0 0 0-2-2h-20a2 2 0 0 0-2 2v13a10.98 10.98 0 0 0 5.824 9.707l5.176 2.76v-2.267l-4.234-2.258a8.99 8.99 0 0 1-4.766-7.942v-13h20v9h2z"/>
    <path d="m463.078 338.147 1.329-2.576-.044-4.355c0-3.24 3.198-4.787 6.048-3.167 1.323.752 1.646 1.898 1.646 3.401l-.019 3.911 1.257 2.87zm5.099 2.537a1.6 1.6 0 0 1-1.505-1.052h3.009a1.595 1.595 0 0 1-1.504 1.052m5.343-5.26v-4.208c0-2.905-2.393-5.26-5.343-5.26s-5.344 2.355-5.344 5.26v4.208l-2.137 4.208 4.289.049c.411 1.984 3.573 3.113 5.113 1.771.433-.378 1.21-1.303 1.326-1.861l4.233.041z"/>
  </svg>
);

export const RecordingRuleIcon = () => (
  <svg
    viewBox="446.983 310.979 32.123 36.853"
    fill="currentColor"
  >
    <path d="m452.983 324.979 5.524.049-.079 2.005-5.445-.054zm0-6h9.709v2h-9.709z"/>
    <path d="M470.983 312.979a2 2 0 0 0-2-2h-20a2 2 0 0 0-2 2v13a10.98 10.98 0 0 0 5.824 9.707l5.176 2.76v-2.267l-4.234-2.258a8.99 8.99 0 0 1-4.766-7.942v-13h20v9h2z"/>
    <path d="M469.636 323.532c-5.222 0-9.47 3.987-9.47 8.888 0 2.208.888 4.342 2.457 5.969l-5.208 3.767c-.474.343-.746.84-.747 1.366s.272 1.023.746 1.366l3.535 2.56c.347.251.746.384 1.157.384.723 0 1.359-.413 1.659-1.077l2.69-5.964a9.416 8.837 0 0 0 3.18.517c5.223 0 9.471-3.987 9.471-8.888s-4.248-8.888-9.47-8.888m-7.584 22.48-3.436-2.49 6.766-4.893zm7.584-6.474a8 8 0 0 1-2.445-.38l.874-1.939c.09-.198.361-.8-.006-1.32a1.1 1.1 0 0 0-.898-.447c-.325 0-.645.121-1.006.383l-2.033 1.47c-1.32-1.315-2.07-3.07-2.07-4.885 0-3.925 3.402-7.118 7.584-7.118s7.584 3.193 7.584 7.118-3.403 7.118-7.584 7.118"/>
    <path d="M469.636 329.193c-1.896 0-3.439 1.448-3.439 3.227 0 1.78 1.543 3.227 3.439 3.227s3.438-1.448 3.438-3.227c0-1.78-1.542-3.227-3.438-3.227m0 4.684c-.856 0-1.553-.654-1.553-1.457s.697-1.457 1.553-1.457 1.552.654 1.552 1.457-.696 1.457-1.552 1.457"/>
  </svg>
);
