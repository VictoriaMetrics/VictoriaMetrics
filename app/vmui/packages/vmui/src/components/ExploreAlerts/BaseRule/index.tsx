...
const BaseRule = ({ item }: BaseRuleProps) => {
  ...
  return (
    <div className="vm-explore-alerts-rule-item">
      ...
      {!!item?.updates?.length && (
        <>
          <span className="vm-title">{`Last updates ${item.updates.length}/${item.max_updates_entries}`}</span>
          <table>
            <thead>
              <tr>
                <th>Updated at</th>
      ...
      {!!item?.alerts?.length && (
        <>
          <span className="vm-title">Alerts</span>
          <table>
            <colgroup>
            ...
            <thead>
              <tr>
                ...
                <th>State</th>
                <th>Value</th>
                <th className="vm-title">Labels</th>
                <th></th>
              </tr>
            </thead>
            <tbody>
