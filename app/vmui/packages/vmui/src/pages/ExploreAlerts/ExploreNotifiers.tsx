...
const ExploreNotifiers: FC = () => {
  ...
  const toggleExpand = () => {
    const expand = expandNotifiers.size == 0;
    const newExpand = expand ? notifiers.map(notifier => notifier.kind) : [];
    window.localStorage.setItem("expandNotifiers", newExpand.join(","));
    setExpandNotifiers(new Set(newExpand));
  };
  ...
  return (
    <div className="vm-explore-alerts">
      <NotifiersHeader
        ...
        expanded={expandNotifiers.size > 0}
