        ...
        <div className="vm-trace-page-preview">
          <p className="vm-trace-page-preview__text">
            ...
            <a
              ...
              href="https://docs.victoriametrics.com/victoriametrics/single-node-version/#query-tracing"
              target="_blank"
              rel="help noreferrer"
            >
              https://docs.victoriametrics.com/victoriametrics/single-node-version/#query-tracing
            </a>
            {"\n"}
