...
var (
	influxSeriesTotal     = metrics.NewCounter(`vmctl_migration_series_total{mode="influx"}`)
	influxSeriesProcessed = metrics.NewCounter(`vmctl_migration_series_processed{mode="influx"}`)
	influxErrorsTotal     = metrics.NewCounter(`vmctl_migration_errors_total{mode="influx"}`)
)
