...
var (
	vmNativeFlags = []cli.Flag{
		...
		&cli.StringFlag{
			...
			Usage:    "The time filter may contain different timestamp formats. See more details here https://docs.victoriametrics.com/victoriametrics/single-node-version/#timestamp-formats",
			Required: true,
		},
		&cli.StringFlag{
		...
		&cli.StringFlag{
			...
			Usage: "VictoriaMetrics address to perform export from. \n" +
				...
				" If exporting from cluster version see https://docs.victoriametrics.com/victoriametrics/cluster-version/#url-format",
			Required: true,
		},
		&cli.StringFlag{
		...
		&cli.BoolFlag{
			...
			Usage: "Whether to use https://docs.victoriametrics.com/victoriametrics/single-node-version/#how-to-export-data-in-json-line-format " +
				"instead of https://docs.victoriametrics.com/victoriametrics/single-node-version/#how-to-export-data-in-native-format API." +
