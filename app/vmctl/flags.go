...
var (
	globalFlags = []cli.Flag{
		...
		&cli.StringSliceFlag{
			...
			Usage: "Optional URL to push metrics exposed at /metrics page. See https://docs.victoriametrics.com/victoriametrics/single-server-victoriametrics/#push-metrics . " +
