...
var (
	defaultRuleType = flag.String("defaultRuleType", "prometheus", `Default type for rule expressions, can be overridden by type parameter inside the rule group. Supported values: "graphite", "prometheus" and "vlogs", default is "prometheus".`)
)
