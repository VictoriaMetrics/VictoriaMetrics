...
var (
	...
	applyIntervalAsTimeFilter = flag.Bool("datasource.applyIntervalAsTimeFilter", true, "Only work for victoriaLogs rules. Whether to apply the evaluation interval as a time filter for the rules.")
)
