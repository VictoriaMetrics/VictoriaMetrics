...
var (
	addr = flag.String("datasource.url", "", "Datasource compatible with Prometheus or VictoriaLogs HTTP API. It can be single node VictoriaMetrics, vmselect endpoint or VictoriaLogs. Required parameter. "+
