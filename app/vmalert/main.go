...
`)
	...
	debugShowSecrets = flag.Bool("debugShowSecrets", false, "Whether to show sensitive information in web UI or debug mode. It is hidden by default, since it can contain sensitive information such as auth key")
)
