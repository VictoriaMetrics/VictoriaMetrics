...
var (
	...
	maxIdleConnections    = flag.Int("remoteWrite.maxIdleConnections", 100, `Defines the number of idle (keep-alive connections) to -remoteWrite.url. Too low a value may result in a high number of sockets in TIME_WAIT state.`)
