...
//line app/vmalert/tpl/header.qtpl:9
func StreamHeader(qw422016 *qt422016.Writer, r *http.Request, navItems []NavItem, title string, userErr UserError) {
//line app/vmalert/tpl/header.qtpl:9
	qw422016.N().S(`
`)
...
//line app/vmalert/tpl/header.qtpl:75
func WriteHeader(qq422016 qtio422016.Writer, r *http.Request, navItems []NavItem, title string, userErr UserError) {
//line app/vmalert/tpl/header.qtpl:75
...
//line app/vmalert/tpl/header.qtpl:75
func Header(r *http.Request, navItems []NavItem, title string, userErr UserError) string {
//line app/vmalert/tpl/header.qtpl:75
...
func streamprintNavItems(qw422016 *qt422016.Writer, r *http.Request, current string, items []NavItem, userErr UserError) {
//line app/vmalert/tpl/header.qtpl:85
	qw422016.N().S(`
`)
...
//line app/vmalert/tpl/header.qtpl:106
	userErr.StreamRenderIcon(qw422016)
//line app/vmalert/tpl/header.qtpl:106
	qw422016.N().S(`
</nav>
`)
//line app/vmalert/tpl/header.qtpl:108
}

//line app/vmalert/tpl/header.qtpl:108
func writeprintNavItems(qq422016 qtio422016.Writer, r *http.Request, current string, items []NavItem, userErr UserError) {
//line app/vmalert/tpl/header.qtpl:108
	qw422016 := qt422016.AcquireWriter(qq422016)
//line app/vmalert/tpl/header.qtpl:108
...
//line app/vmalert/tpl/header.qtpl:108
func printNavItems(r *http.Request, current string, items []NavItem, userErr UserError) string {
//line app/vmalert/tpl/header.qtpl:108
	qb422016 := qt422016.AcquireByteBuffer()
//line app/vmalert/tpl/header.qtpl:108
