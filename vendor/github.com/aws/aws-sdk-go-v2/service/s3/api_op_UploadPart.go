...
// in the Amazon S3 User Guide. You can optionally request server-side encryption
// where Amazon S3 encrypts your data as it writes it to disks in its data centers
// and decrypts it for you when you access it. You have the option of providing
...
// request to initiate the upload by using CreateMultipartUpload (https://docs.aws.amazon.com/AmazonS3/latest/API/API_CreateMultipartUpload.html)
