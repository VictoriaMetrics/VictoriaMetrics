...
- `-search.maxWorkersPerQuery` limits the maximum number of workers for query processing. The default value will be automatically detected based on number of available CPU cores. The flag value might be reduced for systems with high number of CPUs in order to reduce the lock contention for read queries.
...
```
  ...
  -search.maxWorkersPerQuery int
     The maximum number of workers for query processing. The default value will be automatically detected based on number of available CPU cores. The flag value might be reduced for systems with high number of CPUs in order to reduce the lock contention for read queries.
