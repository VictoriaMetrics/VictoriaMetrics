...
```sh
curl -L -O https://github.com/VictoriaMetrics/VictoriaMetrics/releases/download/v1.23.0-victorialogs/victoria-logs-linux-amd64-v1.23.0-victorialogs.tar.gz
tar xzf victoria-logs-linux-amd64-v1.23.0-victorialogs.tar.gz
...
docker run --rm -it -p 9428:9428 -v ./victoria-logs-data:/victoria-logs-data \
  docker.io/victoriametrics/victoria-logs:v1.23.0-victorialogs -storageDataPath=victoria-logs-data
```
