...
* FEATURE: [`format` pipe](https://docs.victoriametrics.com/victorialogs/logsql/#format-pipe): add support for parsing float Unix timestamps with automatic precision detection. See [this issue](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/8659).
