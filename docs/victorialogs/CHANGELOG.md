...
* BUGFIX: [vmui](https://docs.victoriametrics.com/victoriametrics/single-node-version/#vmui): fix for `showLegend` and `alias` flags in predefined panels. [See this issue](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/7565)
...
* BUGFIX: [vmui](https://docs.victoriametrics.com/victoriametrics/single-node-version/#vmui): fix error messages rendering from overflowing the screen with long messages. See [this issue](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/7207).
...
e BUGFIX: [vmui](https://docs.victoriametrics.com/victoriametrics/single-node-version/#vmui): fix `not found index.js` error when loading vmui in VictoriaLogs. See [this issue](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/6764). Thanks to @yincongcyincong for the [pull request](https://github.com/VictoriaMetrics/VictoriaMetrics/pull/6770).
