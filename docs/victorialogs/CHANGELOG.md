...
* BUGFIX: [LogsQL](https://docs.victoriametrics.com/victorialogs/logsql/): fixed panic during validation of quotes in logsql argument, which was already unquoted. See [#9219](https://github.com/VictoriaMetrics/VictoriaMetrics/pull/9219).
