...
```sh
curl -L -O https://github.com/VictoriaMetrics/VictoriaMetrics/releases/download/v1.22.0-victorialogs/vlogscli-linux-amd64-v1.22.0-victorialogs.tar.gz
tar xzf vlogscli-linux-amd64-v1.22.0-victorialogs.tar.gz
./vlogscli-prod
```
