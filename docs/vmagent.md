...
* `scrape_protocols` - list of supported exposition formats. Should be specified in an order of their priority. Default value is `[PrometheusText, PrometheusProto, OpenMetricsText]`. Supported valeus are:
  ...
  * `OpenMetricsText` - scrape metrics exposed in [OpenMetricsText format](https://github.com/prometheus/docs/blob/main/content/docs/instrumenting/exposition_formats.md#openmetrics-text-format)
