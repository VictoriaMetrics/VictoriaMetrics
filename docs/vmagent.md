...
See the docs at https://docs.victoriametrics.com/vmagent.html .
  ...
  -remoteWrite.maxDiskUsagePerURL array
     The maximum file-based buffer size in bytes at -remoteWrite.tmpDataPath for each -remoteWrite.url. When buffer size reaches the configured maximum, then old data is dropped when adding new data to the buffer. Buffered data is stored in ~500MB chunks. It is recommended set the value for this flag to 500MB. Disk usage is unlimited if the value is set to 0
