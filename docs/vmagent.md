...
* `scrape_response_size_bytes` - size in bytes of response for the given target. This allows to monitor amount of data scraped and to set valid
  `max_scrape_size` for a target
