...
See the docs at https://docs.victoriametrics.com/vmagent.html .
  ...
  -remoteWrite.removeDanglingQueues
     Perform startup check against queues stored in --remoteWrite.tmpDataPath and remove queues without respective --remoteWrite.url. Useful when --remoteWrite.url is changed and old queues are not needed anymore.
