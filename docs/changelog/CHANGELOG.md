...
* FEATURE: [vmagent](https://docs.victoriametrics.com/vmagent/): can change remote write protocol at runtime. See [this issue](https://github.com/VictoriaMetrics/VictoriaMetrics/pull/8462) for details.
