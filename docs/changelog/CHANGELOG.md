...
* FEATURE: [vmauth](https://docs.victoriametrics.com/vmauth/): [dump](https://pkg.go.dev/net/http/httputil#DumpRequest) HTTP requests that missed routing rules. This should improve debugability of vmauth settings.
