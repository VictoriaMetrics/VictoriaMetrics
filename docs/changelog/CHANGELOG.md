...
* BUGFIX: [MetricsQL](https://docs.victoriametrics.com/metricsql/): fix the incorrect empty result of the `ifnot` operator caused by label pushdown. See [this issue](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/8435).
