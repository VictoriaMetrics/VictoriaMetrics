...
* FEATURE: [vmalert](https://docs.victoriametrics.com/vmalert/): support for `Config` parsing multiple doc yaml to return all Groups. This is useful for cases when multiple docs are passed in one yaml
