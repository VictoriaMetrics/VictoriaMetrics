...
* FEATURE: [dashboards](https://github.com/VictoriaMetrics/VictoriaMetrics/blob/master/dashboards): update `operator` dashboard and introduce version for `vm-datasource.`
