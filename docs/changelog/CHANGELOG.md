...
* FEATURE: [vmalert](https://docs.victoriametrics.com/vmalert/): add command-line flag `-notifier.sendTimeout` to control the timeout for pushing alerts to corresponding `-notified.url`. The flag is set to 10s by default.
