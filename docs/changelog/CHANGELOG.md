...
* FEATURE: [vmagent](https://docs.victoriametrics.com/vmagent/): add consistent hashing option for remote write. See [this issue](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/8546) for details.
