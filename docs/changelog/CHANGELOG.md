...
* FEATURE: [vmagent](https://docs.victoriametrics.com/vmagent/) and [Single-node VictoriaMetrics](https://docs.victoriametrics.com/): show only jobs with unhealthy targets if `show_only_unhealthy` filter is enabled on targets page in UI. See [this issue](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/3536).
