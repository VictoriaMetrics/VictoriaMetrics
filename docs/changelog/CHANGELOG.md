...
* BUGFIX: all VictoriaMetrics components: increase default value of `-loggerMaxArgLen` cmd-line flag from 1e3 to 5e3. This should improve visibility on errors produced by very long queries.**
