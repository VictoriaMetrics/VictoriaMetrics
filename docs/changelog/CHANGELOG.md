...
* FEATURE: [vmagent](https://docs.victoriametrics.com/vmagent/): improve performance of streamParse mode on high load. See [this](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/8159) and [this](https://github.com/VictoriaMetrics/VictoriaMetrics/pull/8515) issues for details.
* FEATURE: [vmagent](https://docs.victoriametrics.com/vmagent/): improve vmagent performance on parsing big responses in [stream parsing mode](https://docs.victoriametrics.com/vmagent/#stream-parsing-mode). See [this](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/8159) and [this](https://github.com/VictoriaMetrics/VictoriaMetrics/pull/8515) issues for details.
