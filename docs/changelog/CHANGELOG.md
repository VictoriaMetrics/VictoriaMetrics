...
* FEATURE: [vmalert](https://docs.victoriametrics.com/vmalert/): do not allow to use [time buckets stats pipe](https://docs.victoriametrics.com/victorialogs/logsql/#stats-by-time-buckets) in VictoriaLogs rule expression. As it produces meaningless results and may lead to cardinality issues.
