...
* FEATURE: [vmui](https://docs.victoriametrics.com/#vmui): improve number formatting for better readability on the `Explore Cardinality` page. See [this issue](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/8318).
* FEATURE: [vmui](https://docs.victoriametrics.com/#vmui): add full error message display on the `Explore Cardinality` page.
