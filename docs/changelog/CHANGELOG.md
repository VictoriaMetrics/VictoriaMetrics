...
* FEATURE: [vmauth](https://docs.victoriametrics.com/vmauth/): add `httpListenAddr.disableBuiltinRoutes` configuration flag. It allows to properly route requests to backends with the same routes as vmauth. See [this issue](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/6468) and [this issue](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/7345) for details.
