...
* FEATURE: [vmui](https://docs.victoriametrics.com/#vmui): add functionality to preserve selected columns across page reloads. See [this issue](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/7016).
