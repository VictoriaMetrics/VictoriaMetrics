...
* BUGFIX: [vmagent](https://docs.victoriametrics.com/vmagent/): trim the spaces from both end of the file when specifying `-remoteWrite.bearerTokenFile`. See [this issue](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/6986).
