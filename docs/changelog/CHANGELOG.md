...
* BUGFIX: [Single-node VictoriaMetrics](https://docs.victoriametrics.com/) and `vmstorage` in [VictoriaMetrics cluster](https://docs.victoriametrics.com/cluster-victoriametrics/): Fixes registering metric names in the per-day index for new dates for existing timeseries. See [this](https://github.com/VictoriaMetrics/VictoriaMetrics/pull/6872/) for details.
