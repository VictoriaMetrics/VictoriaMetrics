...
* FEATURE: [vmagent](https://docs.victoriametrics.com/vmagent/): support zstd compression in OTLP ingesion. See [this issue](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/8300).
