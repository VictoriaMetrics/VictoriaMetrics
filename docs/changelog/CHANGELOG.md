...
* FEATURE: [Single-node VictoriaMetrics](https://docs.victoriametrics.com/) and [vmstorage](https://docs.victoriametrics.com/cluster-victoriametrics/): introduce new flags `-storage.cacheShardsCountIndexDBDataBlocks` and `-storage.cacheShardsCountIndexDBIndexBlocks` for cache tuning. See [this issue](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/8204) for details.
