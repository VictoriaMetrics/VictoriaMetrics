...
* FEATURE: [vmagent](https://docs.victoriametrics.com/vmagent/) and [Single-node VictoriaMetrics](https://docs.victoriametrics.com/): support `label_limit` scrape parameter, which defines a labels limit for each scraped sample from a target, where this limit is defined. See [this](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/7660) and [this](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/3233) issues.
