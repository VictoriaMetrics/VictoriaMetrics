...
* BUGFIX: [vmsingle](https://docs.victoriametrics.com/single-server-victoriametrics/), `vmselect` in [VictoriaMetrics cluster](https://docs.victoriametrics.com/cluster-victoriametrics/): exclude default metric name filtering for `limit_offset` function. See [this issue](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/7068).
