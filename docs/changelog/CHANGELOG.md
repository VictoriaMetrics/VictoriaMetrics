...
* FEATURE: [vmalert](https://docs.victoriametrics.com/vmalert/): reduce [templating](https://docs.victoriametrics.com/vmalert/#templating) resource usages for alerting rules.
