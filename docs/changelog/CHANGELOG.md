...
## tip
* FEATURE: [vmagent](https://docs.victoriametrics.com/vmagent/): support firstPromscrapeInterval for calculate first scrape time, scrape the first datapoint as soon as possible. See [this issue](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/7559).
