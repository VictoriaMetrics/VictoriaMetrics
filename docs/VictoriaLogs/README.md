...
See [Quick Start](https://docs.victoriametrics.com/VictoriaLogs/quickstart.html) for getting started with VictoriaLogs.

### Data ingestion

VictoriaLogs can accept logs from popular log collectors via following data ingestion protocols:

- [ElasticSearch / OpenSearch data ingestion format](http://docs.victoriametrics.com/VictoriaLogs/ingestion#elasticsearch-bulk-api--opensearch-bulk-api)
- [JSONLine format](http://docs.victoriametrics.com/VictoriaLogs/ingestion#jsonline)

More info about data ingestion and collectors can be found in [these docs](http://docs.victoriametrics.com/VictoriaLogs/ingestion).
