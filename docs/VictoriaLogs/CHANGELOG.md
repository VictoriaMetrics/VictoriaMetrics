...
* FEATURE: drop logs without non-empty [`_msg`](https://docs.victoriametrics.com/victorialogs/keyconcepts/#message-field) field. See [this issue](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/6785).
