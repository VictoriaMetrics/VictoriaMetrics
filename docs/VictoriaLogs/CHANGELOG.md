...
* FEATURE: [Grafana Loki data ingestion](https://docs.victoriametrics.com/victorialogs/data-ingestion/promtail/): added `/insert/ready` endpoint for Loki healthcheck. See [this issue](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/7824).
