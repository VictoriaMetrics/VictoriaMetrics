...
* FEATURE: [web UI](https://docs.victoriametrics.com/victorialogs/querying/#web-ui): add auto refresh. See [this issue](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/7017).
