...
* BUGFIX: [web UI](https://docs.victoriametrics.com/victorialogs/querying/#web-ui): fix incorrect updating of query and limit fields, as well as the reset of the display tab. See [this issue](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/7279).
