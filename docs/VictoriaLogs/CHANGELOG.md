...
* BUGFIX: [web UI](https://docs.victoriametrics.com/victorialogs/querying/#web-ui): add millisecond timestamp to query by WebUI. See [this issue](https://github.com/VictoriaMetrics/VictoriaMetrics/pull/7848).
