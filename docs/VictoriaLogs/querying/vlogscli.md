...
```sh
curl -L -O https://github.com/VictoriaMetrics/VictoriaMetrics/releases/download/v1.3.0-victorialogs/vlogscli-linux-amd64-v1.3.0-victorialogs.tar.gz
tar xzf vlogscli-linux-amd64-v1.3.0-victorialogs.tar.gz
./vlogscli-prod
```
...
```sh
docker run --rm -it docker.io/victoriametrics/vlogscli:v1.3.0-victorialogs
```
