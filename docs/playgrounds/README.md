...
various services in our k8s playground namespace.
...
TODO: add screenshot from grafana playground https://play-grafana.victoriametrics.com/?orgId=1&from=now-6h&to=now&timezone=browser 
