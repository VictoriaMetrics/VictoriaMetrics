VictoriaMetrics and VictoriaLogs support ingestion [metrics](https://docs.victoriametrics.com/victoriametrics/single-node-version/#sending-data-via-opentelemetry)
...
All supported write endpoints can be found at https://docs.victoriametrics.com/victoriametrics/single-node-version/#how-to-import-time-series-data.
```
...
config:
  ...
  exporters:
    otlphttp/victoriametrics:
      ...
      # Cluster version of VictoriaMetrics will require a different URL - https://docs.victoriametrics.com/victoriametrics/cluster-version/#url-format
...
Check other available metrics by visiting [cardinality explorer](https://docs.victoriametrics.com/victoriametrics/single-node-version/#cardinality-explorer) page.
