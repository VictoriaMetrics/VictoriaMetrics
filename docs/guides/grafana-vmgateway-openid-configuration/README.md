...
services:
  ...
  vmstorage:
    image: victoriametrics/vmstorage:v1.129.0-cluster

  vminsert:
    image: victoriametrics/vminsert:v1.129.0-cluster
    command:
      - -storageNode=vmstorage:8400
      - -httpListenAddr=0.0.0.0:8480

  vmselect:
    image: victoriametrics/vmselect:v1.129.0-cluster
    command:
  ...
  vmgateway-cluster:
    image: victoriametrics/vmgateway:v1.129.0-enterprise
    ports:
      - 8431:8431
    volumes:
