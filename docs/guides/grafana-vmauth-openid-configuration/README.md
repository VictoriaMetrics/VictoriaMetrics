...
services:
  ...
  vmstorage:
    image: victoriametrics/vmstorage:v1.152.0-cluster

  vminsert:
    image: victoriametrics/vminsert:v1.152.0-cluster
    command:
      - -storageNode=vmstorage:8400

  vmselect:
    image: victoriametrics/vmselect:v1.152.0-cluster
    command:
