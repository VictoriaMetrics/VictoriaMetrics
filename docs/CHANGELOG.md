...
* FEATURE: [MetricsQL](https://docs.victoriametrics.com/MetricsQL.html). Implement new MetricsQL functions `sort_by_label_numeric` and `sort_by_label_numeric_desc` which can sort labels by alphanumeric algorithm. See [this feature request](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/2938).
