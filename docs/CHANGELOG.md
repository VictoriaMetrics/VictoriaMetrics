...
* FEATURE: [vmui](https://docs.victoriametrics.com/#vmui): add the ability to select `metrics` without choosing a `job` on the `Explore metrics` page. See [this feature request](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/4248).
