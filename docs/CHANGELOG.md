...
**The `external_labels` field in vmalert-tool [test file](https://docs.victoriametrics.com/vmalert-tool/#test-file-format) will be deprecated soon. Please use `-external.label` command-line flag instead like vmalert. See [this issue](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/6735).**
...
* FEATURE: [vmalert-tool](https://docs.victoriametrics.com/vmalert-tool/): add `-external.label` and `-external.url` command-line flags to perform the same as vmalert. See [this issue](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/6735).
