...
* FEATURE: [vmagent](https://docs.victoriametrics.com/vmagent/): reduce memory usage by making labels compressor for stream aggregators and deduplicators shared.
