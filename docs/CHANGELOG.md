...
* FEATURE: change http success response code of `-/reload` request handler of vmsingle and vminsert to 200. See [this feature request](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/5774).
