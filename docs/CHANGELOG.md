...
**Update notes:** this release introduces backwards-incompatible changes to `vm_partial_results_total` metric by changing its labels.
It is recommended to update queries or dashboards which are relying on this metric. 
