...
* FEATURE: [vmctl](https://docs.victoriametrics.com/vmctl.html): use default step value `month` for `--vm-native-step-interval` command-line flags. See [this issue](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/4309).
