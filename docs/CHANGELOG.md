...
* FEATURE: [vmalert](https://docs.victoriametrics.com/vmalert.html): add unit test for rules, see more [details](https://docs.victoriametrics.com/vmalert.html#unit-testing-for-rules)
