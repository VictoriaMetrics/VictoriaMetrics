...
* BUGFIX: [vmagent](https://docs.victoriametrics.com/vmagent.html): fix check of the DataDog agent path requests when requests have trailing slashes. See [this issue](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/5078).
