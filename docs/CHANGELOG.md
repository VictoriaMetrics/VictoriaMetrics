...
* FEATURE: [vmauth](https://docs.victoriametrics.com/vmauth.html): add `metric_labels` for user section metrics. Introduces `vmauth_user_request_backend_errors_total` metric. See [this feature request](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/5565) for details.
