...
* FEATURE: [vmctl](https://docs.victoriametrics.com/vmctl.html): add support `week` step for time-based chunks. See [this issue](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/4738).
