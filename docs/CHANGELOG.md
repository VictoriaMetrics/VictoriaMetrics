...
* BUGFIX: [vmagent](https://docs.victoriametrics.com/vmagent.html): fixes memory corruption if `remoteWrite.label` is set. [this issue](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/4982)
