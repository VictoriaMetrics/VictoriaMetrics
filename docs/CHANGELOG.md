...
* FEATURE: [vmui](https://docs.victoriametrics.com/#vmui): improvement in the usability of the top queries page. A button for executing and copying the query is added, and a column "Query Time Interval" is introduced. See [this feature request](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/4292) and [this pull request](https://github.com/VictoriaMetrics/VictoriaMetrics/pull/4299).
