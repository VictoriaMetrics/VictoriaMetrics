...
While previously state restore attempt was made for all loaded alerting rules, now it is called only for alerts which became active after the first evaluation. See relevant issue [here](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/2608)
