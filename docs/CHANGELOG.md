...
* BUGFIX: [vmagent](https://docs.victoriametrics.com/vmagent.html): fixed parsing of the relabel config when regex contains escaped symbol `$`. See [the related issue](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/3131).
