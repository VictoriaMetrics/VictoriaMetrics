...
* BUGFIX: properly parse camel case label names such as `CamelCaseLabel` during call `/api/v1/labels`. See [this issue](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/3566).
