...
* FEATURE: [vmui](https://docs.victoriametrics.com/#vmui): add the ability to view and copy the text of a lengthy error in a text field. See [this issue](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/4719).
