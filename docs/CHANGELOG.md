...
* FEATURE: [vmauth-enterprise](https://docs.victoriametrics.com/vmauth.html): add `ip_filters` section in config file with ip ranges `allow_list` and `deny_list`. See [this feature request](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/3491) and [these docs](https://docs.victoriametrics.com/vmauth.html#ip-filters).
