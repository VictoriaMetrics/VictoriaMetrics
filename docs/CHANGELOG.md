...
* FEATURE: [vmalert](https://docs.victoriametrics.com/vmalert.html): add `query_time_alignment` attribute for [Groups](https://docs.victoriametrics.com/vmalert.html#groups), it will align group evaluation time with interval like `datasource.queryTimeAlignment` does. And `datasource.queryTimeAlignment` will be disable by default and deprecated soon. See [this issue](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/5049).
