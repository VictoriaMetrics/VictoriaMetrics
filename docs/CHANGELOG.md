...
* FEATURE: [VictoriaMetrics enterprise](https://docs.victoriametrics.com/enterprise.html): add `-storageNode.discoveryInterval` command-line flag to `vmselect` and `vminsert` to control `dns+srv` discovery load on DNS servers. See [this issue](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/3417).
