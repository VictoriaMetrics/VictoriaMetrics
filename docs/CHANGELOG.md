...
* BUGFIX: [vmagent](https://docs.victoriametrics.com/vmagent.html): respect `0` value for `series_limit` param in [scrape_config](https://docs.victoriametrics.com/sd_configs.html#scrape_configs) even if global limit was set via `-promscrape.seriesLimitPerTarget`. Previously, `0` value will be ignored in favor of `-promscrape.seriesLimitPerTarget`. 
