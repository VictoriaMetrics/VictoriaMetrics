...
* FEATURE: [dashboards/operator](https://grafana.com/grafana/dashboards/17869-victoriametrics-operator/): update dashboard to be compatible with Grafana 10+ version.
