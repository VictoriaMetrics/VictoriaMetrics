...
* FEATURE: [vmalert](./vmalert.md): add command-line flag `-notifier.headers` to allow configuring additional headers for requests to the corresponding `-notifier.url`.
