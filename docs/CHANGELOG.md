...
* FEATURE: [vmselect](https://docs.victoriametrics.com/vmselect/): add command-line flag `-search.tmpBufSizeBytes` to allow configuring tmp file memory size to use memory more efficiently.
