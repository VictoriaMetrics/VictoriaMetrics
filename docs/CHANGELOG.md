...
* FEATURE: [vmctl](https://docs.victoriametrics.com/vmctl.html): increase retry backoff policy delay. This change will increase significant amount of time before retry if heavy request resulted into remote storage becoming overloaded. See [this pull request](https://github.com/VictoriaMetrics/VictoriaMetrics/pull/4442).
