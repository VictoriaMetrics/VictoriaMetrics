...
* BUGFIX: [vmalert](https://docs.victoriametrics.com/vmalert.html): properly set config reaload success metric on config equal. Previously it was set to 0 instead of 1.
