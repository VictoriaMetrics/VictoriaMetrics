...
* FEATURE: [vmctl](https://docs.victoriametrics.com/vmctl.html): set default value for `--vm-native-step-interval` command-line flag to `month`. This enables time-based chunking of data based on monthly [step value](https://docs.victoriametrics.com/vmctl.html#using-time-based-chunking-of-migration) for native mode when using native migration mode. See [this issue](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/4309).
