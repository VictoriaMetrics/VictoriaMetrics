...
* BUGFIX:  [vmagent](https://docs.victoriametrics.com/vmagent.html): properly re-use memory for relabeling during streaming aggreagtion. See [this issue](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/5402) for details.
