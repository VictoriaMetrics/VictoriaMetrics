...
* BUGFIX: [vmagent](https://docs.victoriametrics.com/vmgent.html): fix resource usage by vmagent when file_sd_config can't be read. See [this_issue](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/3989).
