...
* FEATURE: [vmui](https://docs.victoriametrics.com/#vmui): add the ability to filter entries on the Logs Explorer page. See [this issue](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/5678).
