...
* BUGFIX: properly limit the number of tags returns from [Graphite Tags API](https://docs.victoriametrics.com/?highlight=Graphite#graphite-tags-api-usage) by setting flags `--search.maxTagKeys` and `--search.maxTagValues`. Remove redundant limit from [Prometheus api/v1/series](https://docs.victoriametrics.com/Single-server-VictoriaMetrics.html#prometheus-querying-api-usage). See [this issue](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/4339).
