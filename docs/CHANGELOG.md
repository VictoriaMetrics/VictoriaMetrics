...
* BUGFIX: [vmagent](https://docs.victoriametrics.com/vmagent.html): fix multi-series matched aggregator calculation for `total`, `increase` and `count_series` outputs in [streaming aggregation](https://docs.victoriametrics.com/stream-aggregation.html). See [this pull-request](https://github.com/VictoriaMetrics/VictoriaMetrics/pull/4671).
