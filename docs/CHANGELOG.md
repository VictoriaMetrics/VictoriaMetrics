...
* FEATURE: [vmui](https://docs.victoriametrics.com/#vmui): add compact table view on page "Custom panel". See [this issue](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/3241).
