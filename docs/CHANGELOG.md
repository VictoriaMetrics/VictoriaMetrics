...
* BUGFIX: [vmui](https://docs.victoriametrics.com/#vmui): remove send step param for instant queries. See [this issue](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/3896).
