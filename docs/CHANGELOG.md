...
* FEATURE: [vmalert](httpпоs://docs.victoriametrics.com/vmalert.html): support loading of alerting and recording rules from object storages `gcs://`, `gs://`, `s3://`. See more details at [Loading rules from remote storage](https://docs.victoriametrics.com/vmalert.html#loading-rules-from-remote-storage).
