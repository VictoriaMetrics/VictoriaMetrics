...
* FEATURE: [VictoriaMetrics cluster](https://docs.victoriametrics.com/cluster-victoriametrics/): add http header log when query error or slow query occurs to `vmselect`. It can be configured to `-search.logHttpHeaders=X-Webauth-User1,...,X-Webauth-UserN`. [this issue](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/6181).
