...
* BUGFIX: [MetricsQL](https://docs.victoriametrics.com/MetricsQL.html): fix label value when `dst_label` is equal to one of the `src_label`. See this [issue](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/5881) for details.
