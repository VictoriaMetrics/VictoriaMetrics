...
* FEATURE: allow to define min and max TLS version of the http server via `tlsMinVersion` and `tlsMaxVersion` command-line flags. [feature request](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/3090).
