...
* FEATURE: [vmagent](https://docs.victoriametrics.com/vmagent.html): added `max_scrape_size` parameter to a scrape config to set custom scrape limit for a job and `scrape_response_size_bytes` metric. 
