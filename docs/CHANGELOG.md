...
* BUGFIX: [vmagent](https://docs.victoriametrics.com/vmagent.html): fix behaivor of `streamAgg.dropInput` command-line flag with empty config of streaming aggregation. See [this issue](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/5207).
