...
* FEATURE: vmalert: support define `step` to build query request for each alerting/recording rule. See [this feature request](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/3741).
