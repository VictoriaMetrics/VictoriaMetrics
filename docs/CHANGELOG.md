...
* FEATURE: [vmagent](https://docs.victoriametrics.com/vmagent.html): reduces load on kubernetes control plane during service discovery. See [this issue](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/4855) for details.
