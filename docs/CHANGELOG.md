...
* FEATURE: [vmui](https://docs.victoriametrics.com/#vmui): rollback table with the highest number of unique values in the main page. This table helps to find labels with huge unique values. See [issue](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/4213).
