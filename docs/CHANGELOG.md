...
* FEATURE: [vmagent](https://docs.victoriametrics.com/vmagent.html): add `discard_samples_older_than` parameter to streaming aggregation config. See [this issue](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/4068).
