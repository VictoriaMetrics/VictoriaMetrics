...
* BUGFIX: fix `opentsdb` endpoint to support both seconds and milliseconds timestamps.  Thanks to @Droxenator for the [pull request](https://github.com/VictoriaMetrics/VictoriaMetrics/pull/3810).
