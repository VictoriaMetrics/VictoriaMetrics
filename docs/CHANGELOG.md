...
* BUGFIX: [vmagent](https://docs.victoriametrics.com/vmagent.html): fix watcher start order for roles endpoints and endpointslice in [kubernetes_sd_configs](https://docs.victoriametrics.com/sd_configs.html#kubernetes_sd_configs). Previously the groupWatcher could be mistakenly stopped when requests for pod or services resources take too long. See [this pull request](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/5557).
