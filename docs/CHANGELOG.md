...
* FEATURE: use `-httpAuth.*` flags as a rollback for `-*AuthKey` flags when `-httpAuth.*` flags are set. See [this issue](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/3060).
