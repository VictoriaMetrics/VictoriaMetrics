...
* FEATURE: [vmui](https://docs.victoriametrics.com/#vmui): add support for Prometheus data on the `Explore Cardinality` page. See [this issue](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/4320) and [these pull request](https://github.com/VictoriaMetrics/VictoriaMetrics/pull/4713).
