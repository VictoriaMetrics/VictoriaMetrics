...
* FEATURE: [vmui](https://docs.victoriametrics.com/#vmui): add a field that allows specifying the maximum number of log entries displayed. See [this issue](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/5674).
