...
* BUGFIX: [vmagent](https://docs.victoriametrics.com/vmagent.html): fix support of legacy DataDog agent in vmagent. See [this issue](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/5078).
