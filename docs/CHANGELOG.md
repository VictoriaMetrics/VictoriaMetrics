...
* * FEATURE: [vmbackupmanager](https://docs.victoriametrics.com/vmbackupmanager/): perform storage availability check on start. This helps to tolerate storage startup delay and avoid vmbackupmanager restarts. See [this issue](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/5859).
