...
* FEATURE: [vmalert](https://docs.victoriametrics.com/vmalert.html): add `eval_offset` attribute for Groups. If specified, Group will be evaluated at the exact offset in the range of [0...interval]. See [this issue](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/3409) for details.
