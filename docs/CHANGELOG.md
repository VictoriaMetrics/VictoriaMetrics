...
* BUGFIX: properly use `-http.pathPrefix` value to construct a link in the header of `/targets` and `/service-discovery` pages. See [this issue](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/5306) for details.
