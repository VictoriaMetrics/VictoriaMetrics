...
* BUGFIX: [vmagent](https://docs.victoriametrics.com/vmagent.html): fix special case for relabel config regex match. See [this issue](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/5297).
