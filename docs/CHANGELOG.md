...
* FEATURE: [vmctl](https://docs.victoriametrics.com/vmctl.html): allow specifying `--vm-insecure-skip-verify` command-line flag to skip TLS certificate verification when VictoriaMetrics listening on https port. See [this pull request](https://github.com/VictoriaMetrics/VictoriaMetrics/pull/5426).
