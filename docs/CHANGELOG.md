...
* BUGFIX: [vmselect](https://docs.victoriametrics.com/Cluster-VictoriaMetrics.html): properly cache query results. Previously cache may return `dgiuplicate series found` error. See [this issues]() for details.
