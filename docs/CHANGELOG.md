...
* BUGFIX: [vmagent](https://docs.victoriametrics.com/vmagent.html): adds missing `/v1/metrics` suffix for `/opentelemetry/api/v1/push/v1/metrics` opentelemetry ingestion path. This suffix is hardcoded at protocol [specification](https://opentelemetry.io/docs/specs/otlp/#otlphttp-request)
