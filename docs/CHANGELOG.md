...
* BUGFIX: [vmbackup](https://docs.victoriametrics.com/vmbackup.html): fix error when creating a full backup using the `-origin` flag. See [this issue](https://github.com/VictoriaMetrics/VictoriaMetrics/pull/5144) for details.
