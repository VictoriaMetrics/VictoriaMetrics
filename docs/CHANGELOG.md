...
* FEATURE: [vmalert](https://docs.victoriametrics.com/vmalert.html). add the ability to validate MetricsQL functions in the alert rules expressions. See [this issue](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/4933). 
