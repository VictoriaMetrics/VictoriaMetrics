...
* FEATURE: [vmbackupmanager](https://docs.victoriametrics.com/vmbackupmanager/): enable storage health check before [vmbackupmanager](https://docs.victoriametrics.com/vmbackupmanager/) starts to create the backup. See [this issue](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/5859).
