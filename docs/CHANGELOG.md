...
* FEATURE: `vmselect` reduce CPU usage by 10%. Due to optimizations at `processSearchQuery`  method, it allocates less memory and reduces pressure for garbage-collector. 
