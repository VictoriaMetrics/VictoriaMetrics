...
* FEATURE: [VictoriaMetrics](https://docs.victoriametrics.com/Single-server-VictoriaMetrics.html). Introduce flag `search.maxPointsPerTimeSeriesSubquery` which can be used if you need better resolution result for your sub-query. See [this feature request](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/2922).
