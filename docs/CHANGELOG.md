...
* BUGFIX: [vmagent](https://docs.victoriametrics.com/vmagent/): Fix `-usePromCompatibleNaming` sometimes does not work in vmagent [pull request](https://github.com/VictoriaMetrics/VictoriaMetrics/pull/6776).
