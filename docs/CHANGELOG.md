...
* FEATURE: [vmui](https://docs.victoriametrics.com/#vmui): add explanation about tsdb usage in cluster version, show number of values via provided `/api/v1/<lable>/values` API. See [this issue](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/3070).
