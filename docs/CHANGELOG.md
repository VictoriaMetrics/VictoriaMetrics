...
* FEATURE: [vmagent](https://docs.victoriametrics.com/vmagent.html): added global aggregator and deduplicator. See [this issue](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/5467).
