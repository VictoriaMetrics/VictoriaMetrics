...
* FEATURE: support query tracing for VictoriaMetrics single-node via passing `trace_query=true` GET param to the query request. See more details about [query tracing](https://docs.victoriametrics.com/Single-server-VictoriaMetrics.html#query-tracing).
