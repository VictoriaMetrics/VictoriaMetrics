...
* FEATURE: [vmagent](https://docs.victoriametrics.com/vmagent.html): Allow using `series_limit` and `sample_limit` with [streamParse](https://docs.victoriametrics.com/vmagent.html#stream-parsing-mode) mode. See [this issue](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/3458) for details.
