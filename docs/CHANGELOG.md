...
* FEATURE: [vmagent](https://docs.victoriametrics.com/vmagent/): stop adding default port 80/443 for scrape URL without a port. See [this issue](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/6792).
