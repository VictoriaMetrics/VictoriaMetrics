...
* FEATURE: [vmui](https://docs.victoriametrics.com/#vmui): enhanced autocomplete functionality with caching. See [this issue](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/5348).
