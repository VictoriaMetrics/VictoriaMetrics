...
* FEATURE: add href for `-/reload` request handler in vmsingle's landing page. See [this feature request](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/5774).
