...
```
  ...
  -search.tmpBufSizeBytes
     The size of in-memory buffers used by vmselect during processing vmstorage responses.By default, the size is automatically calculated based on available memory.
