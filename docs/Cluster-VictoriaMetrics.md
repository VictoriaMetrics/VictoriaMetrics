...
> Note that `vmselect` despite being stateless still requires some disk space (couple of GBs) for temporary caches. Refer to the `-cacheDataPath` command-line flag for more details.
