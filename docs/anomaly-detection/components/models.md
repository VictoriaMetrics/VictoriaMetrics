...
- `scale` (float): (Available since [v1.18.8](https://docs.victoriametrics.com/anomaly-detection/changelog/#v1188)) Is used to adjust the margin between `yhat` and [`yhat_lower`, `yhat_upper`]. New margin = `|yhat_* - yhat_lower| * scale`.
