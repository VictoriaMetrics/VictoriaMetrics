...
- In the tutorial, we'll be using the following VictoriaMetrics components:
  -  [VictoriaMetrics Single-Node](https://docs.victoriametrics.com/victoriametrics/single-server-victoriametrics/) (v1.121.0)
  -  [vmalert](https://docs.victoriametrics.com/victoriametrics/vmalert/) (v1.121.0)
  -  [vmagent](https://docs.victoriametrics.com/victoriametrics/vmagent/) (v1.121.0)
