...
- v1.102.x - the latest one is [v1.102.7 LTS release](https://github.com/VictoriaMetrics/VictoriaMetrics/releases/tag/v1.102.7)
- v1.97.x - the latest one is [v1.97.12 LTS release](https://github.com/VictoriaMetrics/VictoriaMetrics/releases/tag/v1.97.12)
