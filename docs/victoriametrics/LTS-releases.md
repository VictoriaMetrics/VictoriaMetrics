...
- v1.122.x - the latest one is [v1.122.8 LTS release](https://github.com/VictoriaMetrics/VictoriaMetrics/releases/tag/v1.122.8)
- v1.110.x - the latest one is [v1.110.23 LTS release](https://github.com/VictoriaMetrics/VictoriaMetrics/releases/tag/v1.110.23)
