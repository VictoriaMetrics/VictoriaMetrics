...
- v1.122.x - the latest one is [v1.122.6 LTS release](https://github.com/VictoriaMetrics/VictoriaMetrics/releases/tag/v1.122.6)
- v1.110.x - the latest one is [v1.110.21 LTS release](https://github.com/VictoriaMetrics/VictoriaMetrics/releases/tag/v1.110.21)
