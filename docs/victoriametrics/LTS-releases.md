...
so non-enterprise users are advised to regularly [upgrade](https://docs.victoriametrics.com/victoriametrics/single-node-version/#how-to-upgrade-victoriametrics) VictoriaMetrics products
