...
* `vmauth_user_request_body_buffered_bytes` [gauge](https://docs.victoriametrics.com/victoriametrics/keyconcepts/#gauge) - the current amount of request body bytes buffered in memory for the given `username`
...
* `vmauth_unauthorized_user_request_body_buffered_bytes` [gauge](https://docs.victoriametrics.com/victoriametrics/keyconcepts/#gauge) - the current amount of request body bytes buffered in memory for unauthorized user
...
Top users by buffered request body memory can be queried as `topk(10, vmauth_user_request_body_buffered_bytes)`.
