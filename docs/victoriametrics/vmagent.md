...
* `accept_encoding: "gzip, zstd, br"` for specifying the preferred `Accept-Encoding` header dynamically. Supported values: `gzip` (default), `zstd`, `br`, `identity`, or a comma-separated list of these.
