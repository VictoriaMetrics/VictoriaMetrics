...
and [forwards collected data to VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics/blob/55e3ccb5f02abeb7c6da3b7a7e8beb191d2570aa/deployment/docker/compose-vm-cluster.yml#L16).
