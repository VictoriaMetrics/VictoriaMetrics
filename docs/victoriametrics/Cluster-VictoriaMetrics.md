...
```shellhelp
  ...
  - search.logRequestHeaders array
     Optional log request headers to HTTP requests made by vmselect; usage: -search.logRequestHeaders=X-Webauth-User1,...,X-Webauth-UserN.
