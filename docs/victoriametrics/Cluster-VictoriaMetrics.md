...
If one cluster misses samples that are available in another, see [how to recover missing data](https://docs.victoriametrics.com/victoriametrics/data-recovery/).
