...
See the docs at https://docs.victoriametrics.com/victoriametrics/cluster-victoriametrics/ .
  ...
  -secret.flags array
     ...
     Value can contain comma inside single-quoted or double-quoted string, {}, [] and () braces.
  -selectNode array
     The '/internal/resetRollupResultCache' call will be propagated to the listed vmselects. If this flag isn't set, then cache need to be purged from each vmselect individually. Comma-separated addresses of vmselect nodes; usage: -selectNode=vmselect-host1,...,vmselect-hostN
     Supports an array of values separated by comma or specified via multiple flags.
     Value can contain comma inside single-quoted or double-quoted string, {}, [] and () braces.
  -storageNode array
