...
* BUGFIX: [vmauth](https://docs.victoriametrics.com/victoriametrics/vmauth/): return `408` instead of `400` when request body reading fails. This prevents `vmagent` from incorrectly downgrading the remote write protocol and dropping data when `vmauth` works as the proxy of remote write service. See [#11272](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/11272).
