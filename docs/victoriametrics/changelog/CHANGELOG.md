...
* Feature: [MetricsQL](https://docs.victoriametrics.com/victoriametrics/metricsql/): support [label_split](https://docs.victoriametrics.com/victoriametrics/metricsql/#label_split) function to split label values by a separator.
