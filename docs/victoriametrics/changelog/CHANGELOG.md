...
* BUGFIX: `vmstorage` in [VictoriaMetrics cluster](https://docs.victoriametrics.com/victoriametrics/cluster-victoriametrics/): fix unexpected result of `/api/v1/label/{}/values` due to variable shadowing. See [#10294](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/10294)
