...
* FEATURE: [vmsingle](https://docs.victoriametrics.com/victoriametrics/single-server-victoriametrics/) and `vmstorage` in [VictoriaMetrics cluster](https://docs.victoriametrics.com/victoriametrics/cluster-victoriametrics/): add `-fs.disableAdviseRandomRead` command-line flag, which can reduce disk I/O and improve page cache efficiency by disabling OS readahead for data part files. For now, the flag is disabled by default. To enable, set `-fs.disableAdviseRandomRead=false`. If you experience issues after enabling this feature, please [leave a comment](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/11461) with details. See [#11461](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/11461).
