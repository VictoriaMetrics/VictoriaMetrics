...
FEATURE: Attach additional information to logs when internal throttling occurs. For example, vmagent throttles printing of the OpenTelemetry row parse error to every 5 seconds. See [#9498](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/9498).
