...
* BUGFIX: [vmbackup](https://docs.victoriametrics.com/vmbackup/): fix the bug where ending with a trailing forward slash in `-storageDataPath` would cause `vmbackup` to panic. See [#10823](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/10823). Thanks to @utafrali for the contribution.
