...
* BUGFIX: [vmalert-tool](https://docs.victoriametrics.com/victoriametrics/vmalert-tool/): print proper error message when templating function fails during execution. Previously, vmalert-tool could throw a misleading panic message instead.
