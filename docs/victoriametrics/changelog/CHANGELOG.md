...
* FEATURE: [vmalert](https://docs.victoriametrics.com/victoriametrics/vmalert/): show rule evaluation duration on the `/groups` page and allow sorting groups and rules by duration. See [#3371](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/3371).
