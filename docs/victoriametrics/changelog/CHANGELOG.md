...
* BUGFIX: [stream aggregation](https://docs.victoriametrics.com/victoriametrics/stream-aggregation/): fix [sum_samples_total](https://docs.victoriametrics.com/victoriametrics/stream-aggregation/configuration/#sum_samples_total) producing non-monotonic and undercounted output when `enable_windows: true` is set. Previously, the blue and green aggregation windows maintained independent cumulative sums and alternately wrote them under the same metric name, causing repeated, undercounted, or decreasing values. See [#11261](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/11261).
