...
* BUGFIX: [vmalert](https://docs.victoriametrics.com/victoriametrics/vmalert/): add support for the `/api/v1/status/buildinfo` endpoint. Previously, requests to this path returned `400` error, which made Grafana treat `vmalert` as a failing datasource and skip loading its alerting rules. See [#11308](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/11308).
