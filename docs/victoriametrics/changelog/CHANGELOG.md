...
* FEATURE: [vmui](https://docs.victoriametrics.com/victoriametrics/single-server-victoriametrics/#vmui): use `expr.hide` query argument to preserve hidden queries state.
