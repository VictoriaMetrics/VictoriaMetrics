...
* FEATURE: all VictoriaMetrics components: expose operating system kernel metadata metric. See [#10481](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/10481).
