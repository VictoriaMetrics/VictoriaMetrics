...
* BUGFIX: [vmalert](https://docs.victoriametrics.com/victoriametrics/vmalert/): fix deduplicated metrics for dynamically discovered notifiers via Consul and DNS. See [#9260](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/9260).
