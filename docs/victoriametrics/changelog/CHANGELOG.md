...
* FEATURE: [vmui](https://docs.victoriametrics.com/#vmui): add `Requests count` and `Last request` columns to Cardinality Explorer to show metric usage. See [this issue](https://github.com/VictoriaMetrics/VictoriaMetrics/pull/6145).
