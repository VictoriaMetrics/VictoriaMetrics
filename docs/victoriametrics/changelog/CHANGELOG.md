...
* FEATURE: `vmstorage` in [VictoriaMetrics cluster](https://docs.victoriametrics.com/victoriametrics/cluster-victoriametrics/): support accept ingestion via Prometheus Remote Write v1 protocol. This feature could be enabled by the `-enableIngestionAPI` command-line flag and is disabled by default. See [#11252](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/11252).
