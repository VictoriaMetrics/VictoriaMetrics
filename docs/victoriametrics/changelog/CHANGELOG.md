...
* FEATURE: [vmalert](https://docs.victoriametrics.com/vmalert/): respect group concurrency setting in [replay mode](https://docs.victoriametrics.com/victoriametrics/vmalert/#rules-backfilling) when `-replay.rulesDelay=0`. See this [issue](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/7387) for details. Thanks to @BenNF for the [pull request](https://github.com/VictoriaMetrics/VictoriaMetrics/pull/9214).
