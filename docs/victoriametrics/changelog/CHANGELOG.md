...
* BUGFIX: [vmsingle](https://docs.victoriametrics.com/victoriametrics/single-server-victoriametrics/) and `vmstorage` in [VictoriaMetrics cluster](https://docs.victoriametrics.com/victoriametrics/cluster-victoriametrics/): fix lock contention in ingestion path that causes frequent context switches and storage connection saturation spikes. See [#10367](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/10367).
