...
* FEATURE: [vmsingle](https://docs.victoriametrics.com/victoriametrics/single-server-victoriametrics/) and `vmstorage` in [VictoriaMetrics cluster](https://docs.victoriametrics.com/victoriametrics/cluster-victoriametrics/): optimize connection reuse for `vmselect` to `vmstorage` in [VictoriaMetrics cluster](https://docs.victoriametrics.com/victoriametrics/cluster-victoriametrics/). The optimization reduces the number of connections created by `vmselect` to `vmstorage` when using `-search.maxConcurrentRequests`. See [#9374](https://github.com/VictoriaMetrics/VictoriaMetrics/pull/9374).
