...
* FEATURE: [vmalert](https://docs.victoriametrics.com/vmalert/): Add `debug` option for [group](https://docs.victoriametrics.com/vmalert/#groups), which enables debug mode for all rules within the group.
