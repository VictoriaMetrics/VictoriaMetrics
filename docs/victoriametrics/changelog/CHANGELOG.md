...
* FEATURE: [vmagent](https://docs.victoriametrics.com/victoriametrics/vmagent/): expose `vm_promscrape_config_hash` metric containing a hash of the loaded scrape configuration. This metric can be used for detecting configuration divergence across `vmagent` instances in [cluster mode](https://docs.victoriametrics.com/victoriametrics/vmagent/#scraping-big-number-of-targets). See [these docs](https://docs.victoriametrics.com/victoriametrics/vmagent/#detecting-config-divergence-in-cluster-mode) for details. Issue [#8747](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/8747).
