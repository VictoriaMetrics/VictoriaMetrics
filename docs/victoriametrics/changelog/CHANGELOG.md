...
* FEATURE: [vmagent](https://docs.victoriametrics.com/vmagent/): support configuring different `-remoteWrite.queues` per remoteWrite url. See [#10270](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/10270).
