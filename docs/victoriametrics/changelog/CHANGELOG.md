...
* BUGFIX: [vmsingle](https://docs.victoriametrics.com/victoriametrics/single-server-victoriametrics/) and `vmselect` in [VictoriaMetrics cluster](https://docs.victoriametrics.com/victoriametrics/cluster-victoriametrics/): accumulate `vm_metric_rows_skipped_total` metric locally per worker before updating the global counter to reduce CPU overhead during storage block unpacking. See [#11569](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/11569).
