...
* BUGFIX: [vmagent](https://docs.victoriametrics.com/victoriametrics/vmagent/), [vmalert](https://docs.victoriametrics.com/victoriametrics/vmalert/), [vmauth](https://docs.victoriametrics.com/victoriametrics/vmauth/): fix a data race occurring when remote server returns an immediate response without reading the HTTP request body completely. See [#11507](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/11507) and [#11508](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/11508).
