...
* FEATURE: [dashboards/all](https://github.com/VictoriaMetrics/VictoriaMetrics/blob/master/dashboards): show Pods alongside Instance if available. See [#10032](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/10032).
