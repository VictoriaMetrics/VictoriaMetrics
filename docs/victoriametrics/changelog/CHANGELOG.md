...
## tip
* FEATURE: record all logs in `vm_log_messages_total` regardless of the log level set via `-loggerLevel` flag. This will be helpful in troubleshooting. See [#10304](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/10304)
