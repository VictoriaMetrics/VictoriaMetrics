...
* BUGFIX: [vmsingle](https://docs.victoriametrics.com/victoriametrics/single-server-victoriametrics/) and `vmstorage` in [VictoriaMetrics cluster](https://docs.victoriametrics.com/victoriametrics/cluster-victoriametrics/): fixes rare metrics metadata records corruption. See [#11384](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/11384).
