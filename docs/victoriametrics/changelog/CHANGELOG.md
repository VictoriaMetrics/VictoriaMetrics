...
* FEATURE: [stream aggregation](https://docs.victoriametrics.com/victoriametrics/stream-aggregation/): add new output `sum_last` that sum only last value for each metric on aggregation interval. See [#11011](https://github.com/VictoriaMetrics/VictoriaMetrics/pull/11011).
