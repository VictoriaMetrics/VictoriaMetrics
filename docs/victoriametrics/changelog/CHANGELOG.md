...
* BUGFIX: [vmalert](https://docs.victoriametrics.com/vmalert/): fix alert group ids in UI. See [this issue](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/8773).
