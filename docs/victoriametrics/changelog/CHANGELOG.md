...
* BUGFIX: [vmsingle](https://docs.victoriametrics.com/victoriametrics/single-server-victoriametrics/) and `vmselect` in [VictoriaMetrics cluster](https://docs.victoriametrics.com/victoriametrics/cluster-victoriametrics/): fix `buckets_limit()` so leading `NaN` values at the beginning of a query range don't corrupt per-bucket hit calculation and prevent empty buckets from being removed. See [#10488](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/10488).
