...
* BUGFIX: [vmauth](https://docs.victoriametrics.com/victoriametrics/vmauth/): prevent rare panic introduced at v1.133.0 release. See [#10806](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/10806).
