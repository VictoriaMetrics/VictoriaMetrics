...
* BUGFIX: [vmalert](https://docs.victoriametrics.com/victoriametrics/vmalert/): properly reload `alert_relabel_configs` at [notifier-configuration-file](https://docs.victoriametrics.com/victoriametrics/vmalert/#notifier-configuration-file). See [#11635](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/11635).
