...
* FEATURE: [vmagent](https://docs.victoriametrics.com/victoriametrics/vmagent/): add `-configCheckInterval` command-line flag for periodically reloading all configuration files supported by the `/-/reload` endpoint.
