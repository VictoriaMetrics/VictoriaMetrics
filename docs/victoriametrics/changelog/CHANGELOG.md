...
* FEATURE: [vmctl](https://docs.victoriametrics.com/victoriametrics/vmctl/): add metrics for tracking the migration progress. See [these docs](https://docs.victoriametrics.com/victoriametrics/vmctl/#monitoring-the-migration-process) for the details.
