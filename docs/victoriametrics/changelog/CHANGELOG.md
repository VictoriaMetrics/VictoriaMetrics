...
* FEATURE: [vmalert](https://docs.victoriametrics.com/victoriametrics/vmalert/): add `now` function that returns the current Unix timestamp in seconds. It can be used in templates, for example, to calculate duration the alert has been active `{{ (now | toTime).Sub $activeAt }}`. See this issue [#9864](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/9864) for more details. Thank you @nguu0123 for the issue and PR.
