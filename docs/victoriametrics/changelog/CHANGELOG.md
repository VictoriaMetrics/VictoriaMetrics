...
* FEATURE: [vmauth](https://docs.victoriametrics.com/victoriametrics/vmauth/): support printing HTTP headers in the [Access Logs](https://docs.victoriametrics.com/victoriametrics/vmauth/#access-log). Only headers listed in `access_headers.headers` list will be printed in the logs. This feature should help troubleshooting pipelines that rely on HTTP headers.
