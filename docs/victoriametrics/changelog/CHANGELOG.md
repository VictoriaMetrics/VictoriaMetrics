...
* FEATURE: [stream aggregation](https://docs.victoriametrics.com/victoriametrics/stream-aggregation/): change the behavior when both `streamAggr.dropInput` and `streamAggr.keepInput` are set to true. Previously, inputs samples that not matching any aggregation rule were also reserved. See [#9724](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/9724).
