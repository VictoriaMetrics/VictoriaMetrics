...
* BUGFIX: [vmalert](https://docs.victoriametrics.com/victoriametrics/vmalert/): restore support for `query` templates in alert rule labels after the regression introduced in [#9783](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/9783).
