...
* BUGFIX: [alerting rules](https://github.com/VictoriaMetrics/VictoriaMetrics/tree/master/deployment/docker/rules): fix `AlertingRuleResultsApproachingLimit` and `RecordingRuleResultsApproachingLimit` rules for [vmalert](https://docs.victoriametrics.com/victoriametrics/vmalert/). They referenced a non-existing `vmalert_group_rule_results_limit` metric instead of `vmalert_rule_group_results_limit`, so they could never fire. The bug was introduced in [v1.147.0](https://docs.victoriametrics.com/victoriametrics/changelog/#v11470). See [#11182](https://github.com/VictoriaMetrics/VictoriaMetrics/pull/11182).
...
* BUGFIX: [vmalert](https://docs.victoriametrics.com/victoriametrics/vmalert/): rename `vmalert_rule_group_results_limit` to `vmalert_group_rule_results_limit` for improved readability. The metric was originally introduced in [v1.147.0](https://docs.victoriametrics.com/victoriametrics/changelog/#v11470). See [#11182](https://github.com/VictoriaMetrics/VictoriaMetrics/pull/11182).
...
* FEATURE: [vmalert](https://docs.victoriametrics.com/victoriametrics/vmalert/): expose `vmalert_rule_group_results_limit` metric to indicate the number of alerts or recording results that a single rule within the group can produce. See [#11179](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/11179). Thanks to @vinyas-bharadwaj for the contribution.
