...
* BUGFIX: `vmstorage` in [VictoriaMetrics cluster](https://docs.victoriametrics.com/victoriametrics/cluster-victoriametrics/) and [vmsingle](https://docs.victoriametrics.com/victoriametrics/single-server-victoriametrics/): skip waiting after closing the last connections in VMInsertSrv when shutting down. See[#10136](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/10136) for detail.
