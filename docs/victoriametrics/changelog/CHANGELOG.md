...
* BUGFIX: [vmagent](https://docs.victoriametrics.com/victoriametrics/vmagent/): attach tenant information from  `__tenant_id__` label to the scrapped metadata. See [#10828](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/10828).
