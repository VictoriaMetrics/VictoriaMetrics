...
* FEATURE: [dashboards/per-tenant-statistic](https://github.com/VictoriaMetrics/VictoriaMetrics/blob/master/dashboards/clusterbytenant.json): add instant churn rate panel
