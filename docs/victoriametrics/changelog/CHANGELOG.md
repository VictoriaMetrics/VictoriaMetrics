...
* FEATURE: [dashboards/all](https://github.com/VictoriaMetrics/VictoriaMetrics/blob/master/dashboards): add major and minor page faults panels. See [#9974](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/9974).
