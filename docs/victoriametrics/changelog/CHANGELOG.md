...
* BUGFIX: [vmalert](https://docs.victoriametrics.com/victoriametrics/vmalert/): use search expression to match group names and rules files. See [#9886](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/9886) for details.
