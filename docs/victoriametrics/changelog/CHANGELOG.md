...
* FEATURE: [vmalert](https://docs.victoriametrics.com/victoriametrics/vmalert/): add `formatTime` template function for formatting time with a custom layout. It accepts either a Unix timestamp directly. For example: `{{ now | formatTime "2006-01-02T15:04:05Z07:00" }}`. See [templating docs](https://docs.victoriametrics.com/victoriametrics/vmalert/#templating). See issue [#10624](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/10624).
