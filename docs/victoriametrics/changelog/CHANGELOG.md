...
* FEATURE: [vmsingle](https://docs.victoriametrics.com/single-server-victoriametrics/), [vmagent](https://docs.victoriametrics.com/vmagent/): add support for Prometheus 3.0 utf8 quoted labels. See [this pull request](https://github.com/VictoriaMetrics/VictoriaMetrics/pull/8692) for details.
