...
* BUGFIX: [vmalert](https://docs.victoriametrics.com/victoriametrics/vmalert/): evaluate rules at the current time instead of one interval in the future after the system wall clock jumps backward. Previously the rule could be evaluated at a future, possibly incomplete, time point, which could lead to false positives. See [#10985](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/10985).
