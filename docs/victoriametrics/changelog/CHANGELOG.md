...
* FEATURE: [vmalert](https://docs.victoriametrics.com/victoriametrics/vmalert/): add `-notifier.utf8StrictMode` command-line flag for sending alert label names to notifiers without replacing unsupported characters with underscores. This is useful for Alertmanager v0.27.0 or newer, which [supports UTF-8 strict mode](https://prometheus.io/docs/alerting/latest/configuration/#utf-8-strict-mode). See [#11629](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/11629).
