...
* BUGFIX: [vmsingle](https://docs.victoriametrics.com/single-server-victoriametrics/): init `vminsert_streamagg_config_last_reload_successful` metric value with `1` when no stream aggregation config is provided. See [this issue](https://github.com/VictoriaMetrics/helm-charts/issues/2119) for details.
