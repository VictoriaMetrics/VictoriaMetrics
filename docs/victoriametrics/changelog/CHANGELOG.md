...
* FEATURE: [vmauth](https://docs.victoriametrics.com/victoriametrics/vmauth/): supports periodically flush response body for streaming responses (e.g. NDJSON) to minimize latency for small chunks. See [VictoriaLogs/#667](https://github.com/VictoriaMetrics/VictoriaLogs/issues/667) for details.
