...
* BUGFIX: [vmalert](https://docs.victoriametrics.com/victoriametrics/vmalert/): fix shutdown race during slow config scrapes. See PR [#11107](https://github.com/VictoriaMetrics/VictoriaMetrics/pull/11107) for details.
