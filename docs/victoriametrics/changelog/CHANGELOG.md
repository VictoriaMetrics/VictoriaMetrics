...
* BUGFIX: [vmagent](https://docs.victoriametrics.com/victoriametrics/vmagent/): fix a data race when sending data to `-remoteWrite.url`. See [#11507](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/11507).
