...
* BUGFIX: [vmselect](https://docs.victoriametrics.com/cluster-victoriametrics/) in [VictoriaMetrics cluster](https://docs.victoriametrics.com/cluster-victoriametrics/): properly return stats response for [metric query stats API]((https://docs.victoriametrics.com/#track-ingested-metrics-usage)). See [this issue](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/8759) for details.
