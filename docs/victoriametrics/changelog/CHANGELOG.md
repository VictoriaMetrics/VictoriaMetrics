...
* FEATURE: [vmagent](https://docs.victoriametrics.com/vmagent/): add support of Zabbix Connector ingestion format. See [these docs](https://docs.victoriametrics.com/victoriametrics/integrations/zabbixconnector/#send-data-from-zabbix-connector) for the details.
