...
* FEATURE: [vmauth](https://docs.victoriametrics.com/victoriametrics/vmauth/):  support `access_log` per-user setting for enabling [access logs printing](https://docs.victoriametrics.com/victoriametrics/vmauth/#access-log). See [#5936](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/5936).
