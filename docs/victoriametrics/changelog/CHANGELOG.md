...
* FEATURE: [vmui](https://docs.victoriametrics.com/victoriametrics/single-server-victoriametrics/#vmui): improve alert styles for better readability and visual consistency. See [#9856](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/9856).
