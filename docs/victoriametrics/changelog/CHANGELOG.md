...
* BUGFIX: [vmagent](https://docs.victoriametrics.com/vmagent/): fix double-free of chunkedbuffer when calling `/target_response` endpoint, which could lead to data races and potential data loss. See [#9466](https://github.com/VictoriaMetrics/VictoriaMetrics/pull/9466).
