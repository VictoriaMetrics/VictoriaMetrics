...
* FEATURE: [vmagent](https://docs.victoriametrics.com/victoriametrics/vmagent/): add [ECS task metadata](https://docs.victoriametrics.com/victoriametrics/vmagent/#ecs-task-metadata) collection via `-containerStats.url` flag or `ECS_CONTAINER_METADATA_URI_V4` env var. Closes [#8429](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/8429).
