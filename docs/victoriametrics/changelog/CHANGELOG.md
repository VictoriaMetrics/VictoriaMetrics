...
* FEATURE: [vmauth](https://docs.victoriametrics.com/victoriametrics/vmauth/): support array claim values in match_claims JWT matching. See [#10647](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/10647).
