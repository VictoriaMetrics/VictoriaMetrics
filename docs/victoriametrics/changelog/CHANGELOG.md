...
* BUGFIX: [vmalert](https://docs.victoriametrics.com/victoriametrics/vmalert/): `vmalert_group_rule_results_limit` was introduced in [v1.147.0](https://docs.victoriametrics.com/victoriametrics/changelog/#v11470) but was accidentally renamed to `vmalert_rule_group_results_limit`. Restore the original metric name. See [#11182](https://github.com/VictoriaMetrics/VictoriaMetrics/pull/11182).
