...
* BUGFIX: [vmsingle](https://docs.victoriametrics.com/victoriametrics/single-server-victoriametrics/) and `vmstorage` in [VictoriaMetrics cluster](https://docs.victoriametrics.com/victoriametrics/cluster-victoriametrics/): fix the logic error in the handling of Composite in the Less method of tagFilter. See [#9127](https://github.com/VictoriaMetrics/VictoriaMetrics/pull/9127) for details.
