...
* BUGFIX: [vmsingle](https://docs.victoriametrics.com/victoriametrics/single-server-victoriametrics/) and `vmselect` in [VictoriaMetrics cluster](https://docs.victoriametrics.com/victoriametrics/cluster-victoriametrics/): align graphite render API process timeout to query deadline, so it can be increased by adjusted `-search.maxQueryDuration` or `timeout` argument in the query. See [#8484](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/8484).
