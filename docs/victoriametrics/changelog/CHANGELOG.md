...
* FEATURE: [vmalert](https://docs.victoriametrics.com/vmalert/): respect group concurrency setting in alert replay mode. See this [doc](https://docs.victoriametrics.com/victoriametrics/vmalert/#rules-backfilling) for details.
