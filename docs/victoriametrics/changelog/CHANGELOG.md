...
* BUGFIX: [vmauth](https://docs.victoriametrics.com/victoriametrics/vmauth/): fix a data race when retrying requests or logging request URI on failed backends. See [#11508](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/11508).
