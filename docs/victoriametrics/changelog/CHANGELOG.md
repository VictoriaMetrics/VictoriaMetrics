...
* BUGFIX: [vmsingle](https://docs.victoriametrics.com/victoriametrics/single-server-victoriametrics/) and `vmstorage` in [VictoriaMetrics cluster](https://docs.victoriametrics.com/victoriametrics/cluster-victoriametrics/): prevent incorrect search results in rare cases. See this issue [#10239](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/10239) for details
