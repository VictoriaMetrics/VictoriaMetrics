...
* BUGFIX: [alerts-vmbackupmanager](https://github.com/VictoriaMetrics/VictoriaMetrics/blob/master/deployment/docker/rules/alerts-vmbackupmanager.yml): prevent default `vmbackupmanager` alerts from firing for intentionally disabled scheduled backups or disabled backup types. See [#11543](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/11543).
