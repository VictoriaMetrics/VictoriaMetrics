...
* FEATURE: all VictoriaMetrics components: enhance [Pressure Stall Information (PSI)](https://docs.kernel.org/accounting/psi.html) metrics detection. See [#metrics-127](https://github.com/VictoriaMetrics/metrics/issues/127). Thanks to @evkuzin for contribution.
* FEATURE: [stream aggregation](https://docs.victoriametrics.com/victoriametrics/stream-aggregation/): add new output function `sum_sample_total`. See [#11002](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/11002).
