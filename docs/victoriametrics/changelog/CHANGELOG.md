...
* FEATURE: [vmagent](https://docs.victoriametrics.com/victoriametrics/vmagent/): support scraping metrics over Unix domain sockets. The socket path can be configured via the `__vm_unix_socket__` target label.
