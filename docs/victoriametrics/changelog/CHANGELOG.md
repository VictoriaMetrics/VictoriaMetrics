...
* BUGFIX: [vmsingle](https://docs.victoriametrics.com/victoriametrics/single-server-victoriametrics/) and `vmselect` in [VictoriaMetrics cluster](https://docs.victoriametrics.com/victoriametrics/cluster-victoriametrics/): accumulate the number of skipped rows locally per worker before updating `vm_metric_rows_skipped_total` metric to reduce CPU contention during storage block unpacking. See [#11569](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/11569).
