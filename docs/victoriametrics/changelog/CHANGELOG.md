...
* FEATURE: [vmauth](https://docs.victoriametrics.com/victoriametrics/vmauth/): add JWT token `match_claims` for requests routing. Read more about configuration in [JWT claim-based request routing](https://docs.victoriametrics.com/victoriametrics/vmauth/#jwt-claim-based-request-routing) documentation. See [#10584](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/10584).
