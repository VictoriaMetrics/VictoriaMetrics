...
* BUGFIX: [vmsingle](https://docs.victoriametrics.com/victoriametrics/single-server-victoriametrics/) and [VictoriaMetrics cluster](https://docs.victoriametrics.com/victoriametrics/cluster-victoriametrics/): fix `inmemoryPart` pool leak caused by missing `decRef` on source parts after in-memory merge. See [#10086](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/10086).
