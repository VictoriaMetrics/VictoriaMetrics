...
* FEATURE: [vmagent](https://docs.victoriametrics.com/vmagent/): remote write client sets content encoding header based on actual body content, rather than relying on configuration. See [this issue](https://github.com/VictoriaMetrics/VictoriaMetrics/pull/8650).
