...
* BUGFIX: [vmagent](https://docs.victoriametrics.com/victoriametrics/vmagent/): fix remote write relabeling config reloading when vmagent is launched with command-line flags pointing to empty configs. Thanks to @ChengChung for the bug report issue [#10211](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/10211).
