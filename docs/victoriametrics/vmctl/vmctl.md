...
```sh
wget https://github.com/VictoriaMetrics/VictoriaMetrics/releases/download/v1.129.1/vmutils-darwin-arm64-v1.129.1.tar.gz

tar xzf vmutils-darwin-arm64-v1.129.1.tar.gz
```
