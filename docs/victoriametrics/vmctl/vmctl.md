...
```sh
wget https://github.com/VictoriaMetrics/VictoriaMetrics/releases/download/v1.129.0/vmutils-darwin-arm64-v1.129.0.tar.gz

tar xzf vmutils-darwin-arm64-v1.129.0.tar.gz
```
