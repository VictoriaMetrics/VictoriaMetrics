...
```sh
wget https://github.com/VictoriaMetrics/VictoriaMetrics/releases/download/v1.141.0/victoria-metrics-linux-amd64-v1.141.0.tar.gz
tar xzf victoria-metrics-linux-amd64-v1.141.0.tar.gz
```
