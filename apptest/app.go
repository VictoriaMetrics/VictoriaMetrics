...
var (
	...
	graphiteListenAddrRE        = regexp.MustCompile(`starting TCP Graphite server at "(.*:\d{1,5})"`)
	openTSDBListenAddrRE        = regexp.MustCompile(`starting TCP OpenTSDB collector at "(.*:\d{1,5})"`)
