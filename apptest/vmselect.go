...
func (app *Vmselect) PrometheusAPIV1Metadata(t *testing.T, metric string, limit, limitPerMetric int, opts QueryOpts) *PrometheusAPIV1Metadata {
	t.Helper()

	values := opts.asURLValues()
	values.Add("metric", metric)
	values.Add("limit", strconv.Itoa(limit))
	values.Add("limit_per_metric", strconv.Itoa(limitPerMetric))
