...
func (app *Vmselect) PrometheusAPIV1Export(t *testing.T, query string, opts QueryOpts) (*PrometheusAPIV1QueryResponse, int) {
	t.Helper()
	...
	res, statusCode := app.cli.PostForm(t, exportURL, values)
...
func (app *Vmselect) PrometheusAPIV1Query(t *testing.T, query string, opts QueryOpts) (*PrometheusAPIV1QueryResponse, int) {
	t.Helper()
...
func (app *Vmselect) PrometheusAPIV1QueryRange(t *testing.T, query string, opts QueryOpts) (*PrometheusAPIV1QueryResponse, int) {
	t.Helper()
...
func (app *Vmselect) PrometheusAPIV1Series(t *testing.T, matchQuery string, opts QueryOpts) (*PrometheusAPIV1SeriesResponse, int) {
	t.Helper()
