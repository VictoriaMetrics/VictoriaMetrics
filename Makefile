...
test:
	go test -gcflags=all=-l ./lib/... ./app/...

test-race:
	go test -race -gcflags=all=-l ./lib/... ./app/...

test-pure:
	CGO_ENABLED=0 go test -gcflags=all=-l ./lib/... ./app/...

test-full:
	go test -gcflags=all=-l -coverprofile=coverage.txt -covermode=atomic ./lib/... ./app/...

test-full-386:
	GOARCH=386 go test -gcflags=all=-l -coverprofile=coverage.txt -covermode=atomic ./lib/... ./app/...
