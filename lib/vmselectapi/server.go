...
// ErrorPrefix is the prefix of error messages generated by vmselect api. It can help the upper-level vmselect to distinguish the underlying storage service is vmstorage or vmselect.
const ErrorPrefix = "vmselect native api"

func ErrorWithVmselectApiPrefix(err error) error {
	if err == nil {
		return nil
	}
