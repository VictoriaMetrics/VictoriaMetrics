...
var (
	...
	tlsMinVersion   = flag.String("tlsMinVersion", "TLS12", "The minimum TLS version that is acceptable")
	tlsMaxVersion   = flag.String("tlsMaxVersion", "TLS13", "The maximum TLS version that is acceptable")
