...
var (
	...
	tlsCipherSuites = flagutil.NewArray("tlsCipherSuite", "Defines a list of comma-separated cipher suites. It can be defined as tls cipher names (TLS_RSA_WITH_AES_128_CBC_SHA,TLS_RSA_WITH_AES_256_CBC_SHA). Used only if -tls is set.")
