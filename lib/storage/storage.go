...
func (s *Storage) DebugFlush() {
	...
	idbPrev, idbCurr := s.getIndexDBs()
	defer s.putIndexDBs(idbPrev, idbCurr)
...
func (s *Storage) getIndexDBs() (prev, curr *indexDB) {
	s.idbLock.Lock()
	defer s.idbLock.Unlock()
	curr = s.idbCurr.Load()
	if curr != nil {
...
func (s *Storage) putIndexDBs(prev, curr *indexDB) {
	if prev != nil {
		prev.decRef()
	}
	if curr != nil {
