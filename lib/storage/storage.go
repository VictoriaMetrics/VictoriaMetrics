...
type Metrics struct {
	...
	TSIDCacheExpireEvictionsBytes uint64
	...
	MetricIDCacheExpireEvictionsBytes uint64
	...
	MetricNameCacheExpireEvictionsBytes uint64
...
func (s *Storage) UpdateMetrics(m *Metrics) {
	...
	m.TSIDCacheExpireEvictionsBytes += s.tsidCache.ExpireEvictionBytes.Load()
	...
	m.MetricIDCacheExpireEvictionsBytes += s.metricIDCache.ExpireEvictionBytes.Load()
	...
	m.MetricNameCacheExpireEvictionsBytes += s.metricNameCache.ExpireEvictionBytes.Load()
