...
func BenchmarkSearchData_variableSeries(b *testing.B) {
	benchmarkSearch_variableSeries(b, benchmarkSearchData)
}

func BenchmarkSearchData_variableDeletedSeries(b *testing.B) {
	benchmarkSearch_variableDeletedSeries(b, benchmarkSearchData)
}

func BenchmarkSearchData_variableTimeRange(b *testing.B) {
	benchmarkSearch_variableTimeRange(b, benchmarkSearchData)
}

func BenchmarkSearchData_variableAll(b *testing.B) {
	benchmarkSearch_variableAll(b, benchmarkSearchData)
}
