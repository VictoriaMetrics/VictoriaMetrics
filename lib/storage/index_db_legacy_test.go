...
func TestLegacyContainsTimeRange(t *testing.T) {
	...
	mrsPrev := testGenerateMetricRowsWithPrefixForTenantID(rng, accountID, projectID, numMetrics, "legacy_prev", trPrev)
	mrsCurr := testGenerateMetricRowsWithPrefixForTenantID(rng, accountID, projectID, numMetrics, "legacy_curr", trCurr)
	mrsPt := testGenerateMetricRowsWithPrefixForTenantID(rng, accountID, projectID, numMetrics, "pt", trPt)
