...
func TestWriteEviction(t *testing.T) {
	...
	synctest.Test(t, func(t *testing.T) {
		...
		// evict all previous records
		rows = []Row{
			{MetricFamilyName: []byte("metric_name_5"), Help: []byte("some useless help message"), Unit: []byte("seconds")},
			...
			{MetricFamilyName: []byte("metric_name_8"), Help: []byte("some useless help message"), Unit: []byte("seconds")},
