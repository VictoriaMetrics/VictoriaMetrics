...
func testStorageRegisterMetricNames(s *Storage) error {
	...
	lns, err := s.SearchLabelNames(nil, accountID, projectID, nil, allDates, 100, 1e9, noDeadline)
	if err != nil {
	...
	addIDs, err := s.SearchLabelValues(nil, accountID, projectID, "add_id", nil, allDates, addsCount+100, 1e9, noDeadline)
	if err != nil {
