...
func TestRowsUnmarshalWithGraphiteHasTimestampFailure(t *testing.T) {
	*metricHasTimestamp = true
	...
	f("aaa;b=a 1;a=z 1123")
	f("aaa;b=a 1; 1123")
}

func TestRowsUnmarshalWithGraphiteHasTimestampSuccess(t *testing.T) {
	*metricHasTimestamp = true
