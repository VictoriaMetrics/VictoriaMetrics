...
//line lib/promscrape/targetstatus.qtpl:182
		qw422016.N().S(`<div class="alert alert-warning" role="alert">Some debugging information is not available, set <b>-promscrape.dropOriginalLabels=false</b> command-line flag to enable it</div>`)
...
//line lib/promscrape/targetstatus.qtpl:212
	qw422016.N().D(num)
//line lib/promscrape/targetstatus.qtpl:212
	qw422016.N().S(`" class="scrape-job table-responsive"><table class="table table-striped table-hover table-bordered table-sm"><thead><tr><th scope="col">Endpoint</th><th scope="col">State</th><th scope="col" title="target labels">Labels</th><th scope="col" title="debug relabeling">Debug relabeling</th><th scope="col" title="total scrapes">Scrapes</th><th scope="col" title="total scrape errors">Errors</th><th scope="col" title="the time of the last scrape">Last Scrape</th><th scope="col" title="the duration of the last scrape">Duration</th><th scope="col" title="the size of the last scrape">Last Scrape Size</th><th scope="col" title="the number of metrics scraped during the last scrape">Samples</th><th scope="col" title="error from the last scrape (if any)">Last error</th></tr></thead><tbody>`)
...
//line lib/promscrape/targetstatus.qtpl:424
...
//line lib/promscrape/targetstatus.qtpl:426
	}
//line lib/promscrape/targetstatus.qtpl:426
	qw422016.N().S(`}`)
//line lib/promscrape/targetstatus.qtpl:428
}
