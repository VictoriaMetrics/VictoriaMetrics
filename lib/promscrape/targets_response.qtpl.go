...
//line lib/promscrape/targets_response.qtpl:4
import (
	qtio422016 "io"
...
//line lib/promscrape/targets_response.qtpl:5
	for _, js := range jts {
//line lib/promscrape/targets_response.qtpl:5
		qw422016.N().S(`job=`)
...
//line lib/promscrape/targets_response.qtpl:6
		qw422016.N().S(` up)
`)
//line lib/promscrape/targets_response.qtpl:7
...
//line lib/promscrape/targets_response.qtpl:40
	qw422016.N().S(redirectPath)
//line lib/promscrape/targets_response.qtpl:40
			...
			qw422016.N().S(`
                    <tr class="table-row border">
                      <td class="endpoint border">
                        <a href="`)
//line lib/promscrape/targets_response.qtpl:65
			qw422016.N().S(ts.endpoint)
//line lib/promscrape/targets_response.qtpl:65
			qw422016.N().S(`">`)
//line lib/promscrape/targets_response.qtpl:65
...
//line lib/promscrape/targets_response.qtpl:68
			if ts.up {
//line lib/promscrape/targets_response.qtpl:68
				qw422016.N().S(`UP`)
//line lib/promscrape/targets_response.qtpl:68
