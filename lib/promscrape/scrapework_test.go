...
func testScrapeWorkScrapeInternalSuccess(t *testing.T, streamParse bool) {
	f := func(data string, cfg *ScrapeWork, dataExpected string, metaDataExpected []prompbmarshal.MetricMetadata) {
		t.Helper()
...
func expectEqualMetadata(mms, mmsExpected []prompbmarshal.MetricMetadata) error {
