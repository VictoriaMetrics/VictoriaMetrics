...
var rpcHandshakeTimeout = flag.Duration("rpc.handshakeTimeout", 3*time.Second, "Timeout for RPC handshake between vminsert/vmselect and vmstorage. Increase this value if transient handshake failures occur.")
